...
public class GBNServerSide
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        // call the constructor of GBNMyClient class
        GBNMyClient c1 = new GBNMyClient("localhost", 1234, 5, "file.txt");  
        ...
        while(!ackSent.contains(totalNoOfPackets))
        {
              ...
              // Clear the byte arrays after every message
